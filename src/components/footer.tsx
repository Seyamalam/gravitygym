        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-xl font-bold bg-gradient-to-r from-white to-lime-400 bg-clip-text text-transparent">
                GRAVITYGYM
              </h3>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="text-gray-400 hover:text-lime-500 transition-colors flex items-center">
                  <span className="h-1 w-1 bg-lime-500 rounded-full mr-2"></span>
                  Home
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-gray-400 hover:text-lime-500 transition-colors flex items-center">
                  <span className="h-1 w-1 bg-lime-500 rounded-full mr-2"></span>
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/services" className="text-gray-400 hover:text-lime-500 transition-colors flex items-center">
                  <span className="h-1 w-1 bg-lime-500 rounded-full mr-2"></span>
                  Services
                </Link>
              </li>
              <li>
                <Link href="/pricing" className="text-gray-400 hover:text-lime-500 transition-colors flex items-center">
                  <span className="h-1 w-1 bg-lime-500 rounded-full mr-2"></span>
                  Pricing
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-gray-400 hover:text-lime-500 transition-colors flex items-center">
                  <span className="h-1 w-1 bg-lime-500 rounded-full mr-2"></span>
                  Contact
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">info@gravitygym.com</span>
              </li>
            </ul>
          </div>
